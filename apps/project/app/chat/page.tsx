      ...
      <AnimatePresence>
        {showSidebar && (
          <motion.div
            ...
            className={`
              fixed inset-y-0 right-0 w-72 md:relative md:w-80 bg-neutral-800 border-l border-neutral-700
              shadow-lg md:shadow-none z-10 flex flex-col
            `}
          >
            ...
            <div className="flex-1 overflow-y-auto p-4">
                  ...
                  users.map((user) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-gray-400 flex items-center">
                          <span className={`h-2 w-2 rounded-full ${user.isOnline ? 'bg-green-500' : 'bg-gray-500'} mr-1.5`}></span>
              ...
              <div className="mt-8">
                <h3 className="font-semibold text-sm text-gray-400 mb-3">Room Information</h3>
